...
"""
Command-line interface to the King API.
"""
...
import kingclient
from kingclient import client as king_client
from kingclient.common import utils
from kingclient import exc
...
class KingShell(object):
    ...
    def _get_keystone_session(self, **kwargs):
        ...
        if verify is None:
            if insecure:
                ...
                # kingclient.common.http.get_system_ca_fle()?
    ...
    def do_bash_completion(self, args):
        ...
        The king.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
